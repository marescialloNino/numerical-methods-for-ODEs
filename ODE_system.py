...
runs = [
    ...
    ["run 3", "crank-nicolson", num_steps_CN[1], err_CN[1],CPU_time_CN[1]],
    ["run 4", "crank-nicolson", num_steps_CN[2],err_CN[2], CPU_time_CN[2]],
    ["run 5", "BDF3", num_steps_BDF3[0], err_BDF3[0],CPU_time_BDF3[0]],
    ["run 6", "BDF3", num_steps_BDF3[1],err_BDF3[1], CPU_time_BDF3[1]],
    ["run 7", "BDF3", num_steps_BDF3[2],err_BDF3[2], CPU_time_BDF3[2]]
